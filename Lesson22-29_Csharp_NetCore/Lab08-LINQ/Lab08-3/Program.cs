namespace Lab08_3
{
    internal class Program
    {
        static void Main(string[] args)
        {
            ...
            //Lấy những từ đầu tiên có chữ t
            var searchword = Words.TakeWhile(w => w.Contains("t"));
            Show<string>(searchword, "Lay nhung tu dau tien co chu t:");
            ...
            //bỏ qua 3 phần tử đầu tiên, lấy tất cả các phần tử các phần tử còn lại
