    ...
    public partial class v1 : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Account__349DA5A6B35C2C78", x => x.AccountId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Category__19093A0BCAA455F1", x => x.CategoryId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Publishe__4C657FABF445316F", x => x.PublisherId);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderBoo__C3905BCFDAA45DA2", x => x.OrderId);
                    table.ForeignKey(
                        name: "FK__OrderBook__Accou__534D60F1",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__Book__3DE0C207EBCEC9CA", x => x.BookId);
                    table.ForeignKey(
                        name: "FK__Book__CategoryId__4E88ABD4",
                        column: x => x.CategoryId,
                        principalTable: "Category",
                        principalColumn: "CategoryId");
                    table.ForeignKey(
                        name: "FK__Book__PublisherI__4D94879B",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK__OrderDet__D3B9D36C1704203B", x => x.OrderDetailId);
                    table.ForeignKey(
                        name: "FK__OrderDeta__BookI__571DF1D5",
                        column: x => x.BookId,
                        principalTable: "Book",
