...
public partial class ShopBookContext : DbContext
{
    public ShopBookContext()
    {
    }

    public ShopBookContext(DbContextOptions<ShopBookContext> options)
        : base(options)
    {
    }
...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=DESKTOP-UH85BEO\\SQLEXPRESS;Database=ShopBook;uid=sa;pwd=123456;MultipleActiveResultSets=True;TrustServerCertificate=True");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Account>(entity =>
        {
            entity.HasKey(e => e.AccountId).HasName("PK__Account__349DA5A6B35C2C78");
        ...
        {
            entity.HasKey(e => e.BookId).HasName("PK__Book__3DE0C207EBCEC9CA");
        ...
        {
            entity.HasKey(e => e.CategoryId).HasName("PK__Category__19093A0BCAA455F1");
        ...
        {
            entity.HasKey(e => e.OrderId).HasName("PK__OrderBoo__C3905BCFDAA45DA2");
        ...
        {
            entity.HasKey(e => e.OrderDetailId).HasName("PK__OrderDet__D3B9D36C1704203B");
        ...
        {
            entity.HasKey(e => e.PublisherId).HasName("PK__Publishe__4C657FABF445316F");
